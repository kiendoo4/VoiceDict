...
def generate_audio_files():
    ...
    audio_content = {
        ...
        'dictionary-step3': 'Bước 3: Nhập từ cần tra. Cuối cùng, nhập từ bạn muốn tra cứu vào ô tìm kiếm. Bạn có thể nhập bằng bàn phím hoặc sử dụng phím Q, W, E, R để tìm kiếm nhanh các từ thông dụng. Phím Q cho Xin chào, phím W cho Cảm ơn, phím E cho Tạm biệt, phím R cho Giúp đỡ. Nhấn Enter để thực hiện tìm kiếm.',
        
        'dictionary-shortcuts': 'Phím tắt hữu ích cho tra từ điển. Nhấn phím mũi tên trái hoặc Backspace để quay lại bước trước. Nhấn phím H để về trang chủ. Nhấn phím Escape để ẩn kết quả. Sử dụng phím cộng và trừ để điều chỉnh kích thước chữ. Nhấn phím 0 để đặt kích thước chữ về bình thường. Nhấn Space để phát hoặc tạm dừng audio hướng dẫn. Trong thanh audio, nhấn mũi tên trái để lùi 10 giây, mũi tên phải để tiến 10 giây.'
    }
