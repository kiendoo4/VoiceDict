...
class AudioPlayer {
  constructor(container, audioFile, title) {
    console.log("AudioPlayer constructor called with:", {
      container,
      audioFile,
      title,
    });
  ...
  initializeElements() {
    ...
    this.playPauseBtn = this.container.querySelector(
      `#play-pause-${this.audioFile}`
    );
    this.progressContainer = this.container.querySelector(
      `#progress-${this.audioFile}`
    );
    this.progressBar = this.container.querySelector(
      `#progress-bar-${this.audioFile}`
    );
    this.audioTime = this.container.querySelector(
      `#audio-time-${this.audioFile}`
    );
    this.volumeSlider = this.container.querySelector(
      `#volume-${this.audioFile}`
    );
  ...
  updateTimeDisplay() {
    ...
    this.audioTime.textContent = `${currentMinutes}:${currentSeconds
      .toString()
